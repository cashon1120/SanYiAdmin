...
export default class BrakingSystemUpdate extends Component {
    state={
        fileList:[]
    }
    //提交验证
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                router.push('/chassis/brakingSystem/accessory');
            }
        });
    }
            ...
            <DetailLayout titletext='修改故障模式' isDetail={false}>
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <FormItem style={{ textAlign: 'center' }}>
                        ...
                        <Link to='/chassis/brakingSystem'><Button type='default'>取消</Button></Link>
                    </FormItem>
                </Form>
                </div>
            </DetailLayout>
