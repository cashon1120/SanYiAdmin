...
export default class TravelSystemDetail extends Component {
    columns=[{
        title: '时间',
        dataIndex: 'time',
        name: 'time',
        ...
        return (
            <DetailLayout titletext='故障模式详情'>
                <div name='行驶系统'>
                    ...
                    <p/>
                    <Table bordered columns={this.columns} dataSource={this.props.TravelSystemState.logData} pagination={false} />
                    <PaginationEx total={this.props.TravelSystemState.logData.length} onChangeEx={this.onChangeEx} />
                </div>
            </DetailLayout>
        )
    }
