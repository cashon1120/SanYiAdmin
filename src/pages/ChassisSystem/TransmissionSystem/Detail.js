...
export default class TransmissionSystemDetail extends Component {
    columns=[{
        title: '时间',
        dataIndex: 'time',
        name: 'time',
        ...
        return (
            <DetailLayout titletext='故障模式详情'>
                <div name='传动系统'>
                    ...
                    <p/>
                    <Table bordered columns={this.columns} dataSource={this.props.TransmissionSystemState.logData} pagination={false} />
                    <PaginationEx total={this.props.TransmissionSystemState.logData.length} onChangeEx={this.onChangeEx} />
                </div>
            </DetailLayout>
        )
    }
