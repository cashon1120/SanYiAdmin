...
const mapDis2Prop = (dispatch) => {
    return {
        addDevice: () => {
            dispatch({
                type: 'TransmissionSystem/Update'
            })
        }
    }
};
...
export default class TransmissionSystemUpdate extends Component {
    state={
        fileList:[]
    }
    //提交验证
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                router.push('/chassis/transmissionSystem/accessory');
            }
        });
    }
    ...
    render() {
        ...
        return (
            <DetailLayout titletext='修改故障模式' isDetail={false}>
                <div name='传动系统'>
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <FormItem style={{ textAlign: 'center' }}>
                        ...
                        <Link to='/chassis/transmissionSystem'><Button type='default'>取消</Button></Link>
                    </FormItem>
                </Form>
                </div>
            </DetailLayout>
