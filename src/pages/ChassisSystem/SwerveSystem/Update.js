...
export default class SwerveSystemUpdate extends Component {
    state={
        fileList:[]
    }
    //提交验证
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                router.push('/chassis/swerveSystem/accessory');
            }
        });
    }
            ...
            <DetailLayout titletext='修改故障模式' isDetail={false}>
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <FormItem style={{ textAlign: 'center' }}>
                        ...
                        <Link to='/chassis/swerveSystem'><Button type='default'>取消</Button></Link>
                    </FormItem>
                </Form>
                </div>
            </DetailLayout>
