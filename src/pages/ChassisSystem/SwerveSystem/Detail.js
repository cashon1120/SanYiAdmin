        ...
        return (
            <DetailLayout titletext='故障模式详情'>
                <div name='转向系统'>
                    ...
                    <p/>
                    <Table bordered columns={this.columns} dataSource={this.props.SwerveSystemState.logData} pagination={false} />
                    <PaginationEx total={this.props.SwerveSystemState.logData.length} onChangeEx={this.onChangeEx} />
                </div>
            </DetailLayout>
        )
    }
