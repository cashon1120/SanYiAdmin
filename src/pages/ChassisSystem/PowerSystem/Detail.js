...
export default class PowerSystemDetail extends Component {
    columns=[{
        title: '时间',
        dataIndex: 'time',
        name: 'time',
        ...
        return (
            <DetailLayout titletext='故障模式详情'>
                <div name='动力系统'>
                    ...
                    <p/>
                    <Table bordered columns={this.columns} dataSource={this.props.PowerSystemState.logData} pagination={false} />
                    <PaginationEx total={this.props.PowerSystemState.logData.length} onChangeEx={this.onChangeEx} />
                </div>
            </DetailLayout>
        )
    }
