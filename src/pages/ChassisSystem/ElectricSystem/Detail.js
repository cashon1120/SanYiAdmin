...
export default class ElectricSystemDetail extends Component {
    columns=[{
        title: '时间',
        dataIndex: 'time',
        name: 'time',
        ...
        return (
            <DetailLayout titletext='故障模式详情'>
                <div name='电气系统'>
                    ...
                    <p/>
                    <Table bordered columns={this.columns} dataSource={this.props.ElectricSystemState.logData} pagination={false} />
                    <PaginationEx total={this.props.ElectricSystemState.logData.length} onChangeEx={this.onChangeEx} />
                </div>
            </DetailLayout>
        )
    }
